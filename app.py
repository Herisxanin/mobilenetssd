...
lineaccesstoken = '8Yvyfy7eH1kvCxAmiG91Bj0hjRbs6E4rtmaSZXz8nEwUVJG94bdVz+ZSw6P/IMbucBuLyqUN0G//X2OzGl7kyJh6wQn0PKPMTtlW4Ih29IDw7iTo7cLdf1LXwSqsvWbv7+toSWZvLsWYQeS7w2oz1gdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            ...
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ชาบูหรือหมูทะดี":
            replyObj = TextSendMessage(text="อันไหนก็อร่อยป่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "อยากไปเที่ยว":
            replyObj = TextSendMessage(text="ไปดิแต่วันไหนจะได้ไปก่อน") 
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/11edc5ed-5922-4ae0-ac06-fc6beb132e7a"
